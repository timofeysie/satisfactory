...
gan.controller: downloadImage {
  path: 'https://upload.wikimedia.org/wikipedia/commons/2/28/',
  filename: 'Mark_Lanegan_%286893952642%29.jpg'
}
gan.controller: linkWrapper.links[0] <https://upload.wikimedia.org/wikipedia/commons/2/28/Mark_Lanegan_%286893952642%29.jpg>
(node:4632) UnhandledPromiseRejectionWarning: [object Uint8Array]
(Use `node --trace-warnings ...` to show where the warning was created)
(node:4632) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by
throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see <https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode>). (rejection id: 1)
...
(node:4632) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by
throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see <https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode>). (rejection id: 4)
id Foo Fighters Geelong
fullUrl <https://commons.wikimedia.org/w/index.php?search=Foo> Fighters Geelong&title=Special:MediaSearch&go=Go
list 0
id Foo Fighters]
fullUrl <https://commons.wikimedia.org/w/index.php?search=Foo> Fighters]&title=Special:MediaSearch&go=Go
list 40
id Geelong
fullUrl <https://commons.wikimedia.org/w/index.php?search=Geelong&title=Special:MediaSearch&go=Go>
list 40
gan.controller: downloadImage {
  path: 'https://upload.wikimedia.org/wikipedia/commons/f/fb/',
  filename: 'Foo_Fighters_-*Southside_Festival_2019_4389*-_2.jpg'
}
gan.controller: linkWrapper.links[0] <https://upload.wikimedia.org/wikipedia/commons/f/fb/Foo_Fighters>_-*Southside_Festival_2019_4389*-_2.jpg
(node:4632) UnhandledPromiseRejectionWarning: [object Uint8Array]
(node:4632) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by
throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see <https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode>). (rejection id: 5)
(node:4632) UnhandledPromiseRejectionWarning: [object Uint8Array]
...
(node:4632) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by
throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see <https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode>). (rejection id: 8)
generateText: Foo Fighters Geelong

The Geelong Cats have been in the running for the AFL's top-10 pick for the next two years,
