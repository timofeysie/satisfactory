...
- Add "copy to meta-description" button next to "Use generated summary" button.
- Add mashup to keywords for mashup type.  Add AI vs Art, AI generated art for single.
- Move identical parts of libs\products\src\lib\containers\product-detail\product-detail.component.html into dumb shared components
