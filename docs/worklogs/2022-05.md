...
*Divide the original height by the original width and then multiply this number by the new width to get the new height.*
...
- add service to call the image GET endpoint
- add the h/w to the json for the image
- create a POST endpoint to take image name, type and desired offset
